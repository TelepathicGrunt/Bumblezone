...
import com.telepathicgrunt.bumblezone.world.dimension.layer.vanilla.AreaTransformer2;
import com.telepathicgrunt.bumblezone.world.dimension.layer.vanilla.Context;
import com.telepathicgrunt.bumblezone.world.dimension.layer.vanilla.DimensionOffset0Transformer;

public class BzBiomeMergeLayer implements AreaTransformer2, DimensionOffset0Transformer {

    public BzBiomeMergeLayer() {}
