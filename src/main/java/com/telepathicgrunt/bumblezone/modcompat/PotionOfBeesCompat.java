...
public class PotionOfBeesCompat
{
	...
	public static void setupPotionOfBees() 
	{
		...
		if (Registry.ITEM.getOrEmpty(POB_POTION_OF_BEES_ITEM_ID).isPresent() && Bumblezone.BZ_CONFIG.BZModCompatibilityConfig.allowPotionOfBeesCompat) {
			PotionOfBeesBeePotionDispenseBehavior.DEFAULT_POTION_BEE_DISPENSE_BEHAVIOR = ((DispenserAccessor)Blocks.DISPENSER).thebumblezone_invokeGetBehaviorForItem(new ItemStack(Registry.ITEM.get(POB_POTION_OF_BEES_ITEM_ID)));
		...
		if (Registry.ITEM.getOrEmpty(POB_SPLASH_POTION_OF_BEES_ITEM_ID).isPresent() && Bumblezone.BZ_CONFIG.BZModCompatibilityConfig.allowSplashPotionOfBeesCompat) {
			PotionOfBeesBeePotionDispenseBehavior.DEFAULT_SPLASH_POTION_BEE_DISPENSE_BEHAVIOR = ((DispenserAccessor)Blocks.DISPENSER).thebumblezone_invokeGetBehaviorForItem(new ItemStack(Registry.ITEM.get(POB_SPLASH_POTION_OF_BEES_ITEM_ID)));
