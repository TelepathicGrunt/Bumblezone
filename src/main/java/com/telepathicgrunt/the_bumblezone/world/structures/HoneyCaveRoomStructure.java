...
public class HoneyCaveRoomStructure extends Structure {
    ...
    public HoneyCaveRoomStructure(StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        return OptimizedJigsawManager.assembleJigsawStructure(
                ...
                this.startPool,
                this.size,
                context.registryAccess().registry(Registry.STRUCTURE_REGISTRY).get().getKey(this),
                centerPos,
                false,
    ...
    public StructureType<?> type() {
        return BzStructures.HONEY_CAVE_ROOM;
    }
}