...
import com.telepathicgrunt.the_bumblezone.mixin.world.TemplateInvoker;
    ...
    protected static Pair<Pair<BlockState, String>, Boolean> blockConversion(IServerWorld world, BlockPos pos, Block block, Random random) {
        ...
        if (block == Blocks.RED_TERRACOTTA || block == Blocks.PURPLE_TERRACOTTA) {
            ...
            if(ModChecker.resourcefulBeesPresent){
                ...
                else if(Bumblezone.BzModCompatibilityConfig.spawnResourcefulBeesHoneycombVariants.get() &&
                        random.nextFloat() < 0.5f)
                {
        ...
        //sugar water stream
            ...
            if(ModChecker.buzzierBeesPresent) {
                return new Pair<>(new Pair<>(BuzzierBeesRedirection.getCrystallizedHoneyBlock(), null), false);
            }
            else {
        ...
        //center
            ...
            if(ModChecker.buzzierBeesPresent && Bumblezone.BzModCompatibilityConfig.allowScentedCandlesSpiderBeeDungeon.get()) {
