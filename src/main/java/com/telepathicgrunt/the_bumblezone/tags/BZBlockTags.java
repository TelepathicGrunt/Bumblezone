...
public class BZBlockTags {
    ...
    public static final ITag.INamedTag<Block> REQUIRED_BLOCKS_UNDER_HIVE_TO_TELEPORT = BlockTags.makeWrapperTag(Bumblezone.MODID+":required_blocks_under_hive_to_teleport");
    public static final ITag.INamedTag<Block> BLACKLISTED_TELEPORTATION_HIVES = BlockTags.makeWrapperTag(Bumblezone.MODID+":blacklisted_teleportable_hive_blocks");
