...
public class BzBlockTags {
    ...
    public static final Tag.Named<Block> ALLOWED_RESOURCEFUL_COMBS = BlockTags.createOptional(new ResourceLocation(Bumblezone.MODID, "allowed_resourceful_bees_combs"));
