...
public class BzFeatures {
    ...
    public static final RegistryObject<Feature<NoneFeatureConfiguration>> HONEY_CRYSTAL_FEATURE = FEATURES.register("honey_crystal_feature", () -> new HoneyCrystalFeature(NoneFeatureConfiguration.CODEC));
