...
public class BzBlocks {
    ...
    public static void registerBlocks() {
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "porous_honeycomb_block"), POROUS_HONEYCOMB);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "filled_porous_honeycomb_block"), FILLED_POROUS_HONEYCOMB);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "empty_honeycomb_brood_block"), EMPTY_HONEYCOMB_BROOD);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "honeycomb_brood_block"), HONEYCOMB_BROOD);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "sugar_infused_stone"), SUGAR_INFUSED_STONE);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "sugar_infused_cobblestone"), SUGAR_INFUSED_COBBLESTONE);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "honey_crystal"), HONEY_CRYSTAL);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "sticky_honey_residue"), STICKY_HONEY_RESIDUE);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "sticky_honey_redstone"), STICKY_HONEY_REDSTONE);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "beehive_beeswax"), BEEHIVE_BEESWAX);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "pile_of_pollen"), PILE_OF_POLLEN);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "honey_web"), HONEY_WEB);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "redstone_honey_web"), REDSTONE_HONEY_WEB);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "honey_cocoon"), HONEY_COCOON);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "royal_jelly_block"), ROYAL_JELLY_BLOCK);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "glistering_honey_crystal"), GLISTERING_HONEY_CRYSTAL);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "carvable_wax"), CARVABLE_WAX);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base"), SUPER_CANDLE_BASE);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_wick"), SUPER_CANDLE_WICK);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_wick_soul"), SUPER_CANDLE_WICK_SOUL);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_black"), SUPER_CANDLE_BASE_BLACK);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_blue"), SUPER_CANDLE_BASE_BLUE);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_brown"), SUPER_CANDLE_BASE_BROWN);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_cyan"), SUPER_CANDLE_BASE_CYAN);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_gray"), SUPER_CANDLE_BASE_GRAY);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_green"), SUPER_CANDLE_BASE_GREEN);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_light_blue"), SUPER_CANDLE_BASE_LIGHT_BLUE);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_light_gray"), SUPER_CANDLE_BASE_LIGHT_GRAY);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_lime"), SUPER_CANDLE_BASE_LIME);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_magenta"), SUPER_CANDLE_BASE_MAGENTA);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_orange"), SUPER_CANDLE_BASE_ORANGE);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_pink"), SUPER_CANDLE_BASE_PINK);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_purple"), SUPER_CANDLE_BASE_PURPLE);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_red"), SUPER_CANDLE_BASE_RED);
        Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(Bumblezone.MODID, "super_candle_base_white"), SUPER_CANDLE_BASE_WHITE);
