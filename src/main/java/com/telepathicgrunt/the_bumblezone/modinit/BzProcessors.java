...
public class BzProcessors {
    ...
    public static void registerProcessors() {
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "bee_dungeon_processor"), BEE_DUNGEON_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "spider_infested_bee_dungeon_processor"), SPIDER_INFESTED_BEE_DUNGEON_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "replace_not_air_processor"), REPLACE_NOT_AIR_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "close_off_outside_fluids_processor"), CLOSE_OFF_OUTSIDE_FLUIDS_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "remove_floating_blocks_processor"), REMOVE_FLOATING_BLOCKS_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "spawner_randomizing_processor"), SPAWNER_RANDOMIZING_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "honeycomb_hole_processor"), HONEYCOMB_HOLE_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "pollen_piling_processor"), POLLEN_PILING_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "fluid_tick_processor"), FLUID_TICK_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "replace_air_processor"), REPLACE_AIR_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "noise_replace_with_properties_processor"), NOISE_REPLACE_WITH_PROPERTIES_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "honeycomb_brood_randomize_processor"), HONEYCOMB_BROOD_RANDOMIZE_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "random_replace_with_properties_processor"), RANDOM_REPLACE_WITH_PROPERTIES_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "pillar_processor"), PILLAR_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "tag_replace_processor"), TAG_REPLACE_PROCESSOR);
        Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, new ResourceLocation(Bumblezone.MODID, "waterlogging_fix_processor"), WATERLOGGING_FIX_PROCESSOR);
    }
}
