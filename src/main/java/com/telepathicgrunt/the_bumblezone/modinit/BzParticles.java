...
public class BzParticles {
    ...
    public static void registerParticles() {
        Registry.register(Registry.PARTICLE_TYPE, new ResourceLocation(Bumblezone.MODID, "pollen_puff_particle"), POLLEN_PARTICLE);
        ...
        Registry.register(Registry.PARTICLE_TYPE, new ResourceLocation(Bumblezone.MODID, "sparkle_particle"), SPARKLE_PARTICLE);
    }
}
