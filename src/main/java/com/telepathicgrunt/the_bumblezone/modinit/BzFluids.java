...
public class BzFluids {
    ...
    public static final RegistryObject<FlowingFluidBlock> HONEY_FLUID_BLOCK = BzBlocks.BLOCKS.register("honey_fluid_block", () -> new HoneyFluidBlock(HONEY_FLUID));
    ...
    public static final ForgeFlowingFluid.Properties HONEY_FLUID_PROPERTIES = new ForgeFlowingFluid.Properties(HONEY_FLUID, HONEY_FLUID_FLOWING,
            ...
            .bucket(BzItems.HONEY_BUCKET).canMultiply().block(HONEY_FLUID_BLOCK);
}
