...
public class BzSounds {
    ...
    public static final RegistryObject<SoundEvent> BUMBLE_BEE_CHESTPLATE_FLYING = SOUND_EVENTS.register("entity.the_bumblezone.bumble_bee_chestplate.fly", () -> new SoundEvent(new ResourceLocation(Bumblezone.MODID, "entity.the_bumblezone.bumble_bee_chestplate.fly")));
