...
public class BzPlacements {
    public static final DeferredRegister<PlacementModifierType<?>> PLACEMENT_MODIFIER = DeferredRegister.create(Registries.PLACEMENT_MODIFIER_TYPE, Bumblezone.MODID);
    ...
    public static final RegistryObject<PlacementModifierType<ConditionBasedPlacement>> CONDITION_BASED_PLACEMENT = PLACEMENT_MODIFIER.register("condition_based_placement", () -> () -> ConditionBasedPlacement.CODEC);
}
