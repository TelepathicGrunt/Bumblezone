...
public class BzItems {
    ...
    public static final RegistryObject<Item> HONEY_BEE_LEGGINGS = ITEMS.register("honey_bee_leggings", () -> new HoneyBeeLeggings(ArmorMaterials.GOLD, EquipmentSlot.LEGS, new Item.Properties().tab(BzItems.BUMBLEZONE_CREATIVE_TAB)));
    public static final RegistryObject<Item> BUMBLE_BEE_CHESTPLATE = ITEMS.register("bumble_bee_chestplate", () -> new BumbleBeeChestplate(ArmorMaterials.GOLD, EquipmentSlot.CHEST, new Item.Properties().tab(BzItems.BUMBLEZONE_CREATIVE_TAB)));
    public static final RegistryObject<Item> STINGLESS_BEE_HELMET = ITEMS.register("stingless_bee_helmet", () -> new StinglessBeeHelmet(ArmorMaterials.GOLD, EquipmentSlot.HEAD, new Item.Properties().tab(BzItems.BUMBLEZONE_CREATIVE_TAB)));
}