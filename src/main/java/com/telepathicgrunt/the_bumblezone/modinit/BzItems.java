...
public class BzItems {
    ...
    public static final RegistryObject<Item> GLAZED_COCOON = ITEMS.register("glazed_cocoon", () -> new BzBlockItem(BzBlocks.GLAZED_COCOON.get(), new Item.Properties().tab(BUMBLEZONE_CREATIVE_TAB)));
