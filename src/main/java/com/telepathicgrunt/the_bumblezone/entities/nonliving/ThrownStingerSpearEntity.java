...
public class ThrownStingerSpearEntity extends AbstractArrow {
    ...
    private ItemStack spearItem = new ItemStack(BzItems.STINGER_SPEAR);
    ...
    public ThrownStingerSpearEntity(Level level, LivingEntity livingEntity, ItemStack itemStack) {
        super(BzEntities.THROWN_STINGER_SPEAR_ENTITY, livingEntity, level);
        ...
        if (loyalty > 0 && (this.dealtDamage || this.isNoPhysics()) && entity != null) {
            if (!this.isAcceptibleReturnOwner()) {
                ...
                if (this.clientSideReturnSpearTickCount == 0) {
                    this.playSound(BzSounds.STINGER_SPEAR_RETURN, 10.0F, 1.0F);
                }
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        dealtDamage = true;
        SoundEvent soundevent = BzSounds.STINGER_SPEAR_HIT;
            ...
            this.getOwner() instanceof ServerPlayer serverPlayer)
        {
            ...
            if (entity.getType() == EntityType.WITHER && MiscComponent.rootAdvancementDone(serverPlayer)) {
