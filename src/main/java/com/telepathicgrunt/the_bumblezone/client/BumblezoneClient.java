...
public class BumblezoneClient implements ClientModInitializer {
    ...
    private void registerFluidRenders() {
        ...
        FluidRenderHandlerRegistry.INSTANCE.setBlockTransparency(BzBlocks.GLISTERING_HONEY_CRYSTAL, true);
    }
    ...
    public static void registerRenderLayers() {
        ...
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_BLACK);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_BLUE);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_BROWN);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_CYAN);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_GRAY);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_GREEN);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_LIGHT_BLUE);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_LIGHT_GRAY);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_LIME);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_MAGENTA);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_ORANGE);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_PINK);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_PURPLE);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_RED);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_WHITE);
        BlockRenderLayerMap.put(RenderType.cutout(), BzBlocks.STRING_CURTAIN_YELLOW);
