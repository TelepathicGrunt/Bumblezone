...
public class BeeQueenModel extends HierarchicalModel<BeeQueenEntity> {
    ...
    public BeeQueenModel(ModelPart root) {
        ...
        this.segment3 = this.root.getChild("segment3");
        this.segment2 = this.root.getChild("segment2");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition segment3 = root.addOrReplaceChild("segment3", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
        ...
        PartDefinition segment2 = root.addOrReplaceChild("segment2", CubeListBuilder.create().texOffs(0, 40).addBox(3.0F, -10.0F, -8.0F, 10.0F, 10.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition segment1 = root.addOrReplaceChild("segment1", CubeListBuilder.create(), PartPose.offset(2.8299F, 13.8763F, -5.7857F));
        ...
        PartDefinition right2_r1 = legs2.addOrReplaceChild("right2_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 12.7F, 1.15F, 0.01F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-3.0F, 12.7F, 8.15F, 0.01F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(12.04F, -7.6758F, -0.1381F, 2.7286F, -0.1451F, -1.8894F));

        PartDefinition legs1 = segment1.addOrReplaceChild("legs1", CubeListBuilder.create(), PartPose.offset(-2.64F, 4.6186F, 1.2902F));

        PartDefinition right1_r1 = legs1.addOrReplaceChild("right1_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 12.7F, 1.15F, 0.01F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-6.0F, 12.7F, 8.15F, 0.01F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.8101F, -10.4948F, 0.4955F, 2.7286F, -0.1451F, -1.8894F));
        ...
        PartDefinition right3_r1 = legs3.addOrReplaceChild("right3_r1", CubeListBuilder.create().texOffs(0, 0).addBox(2.0F, 3.5F, 2.0F, 1.0F, 2.0F, 0.01F, new CubeDeformation(0.0F))
                .texOffs(2, 0).addBox(-3.0F, 3.5F, 2.0F, 1.0F, 2.0F, 0.01F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6789F, -3.9174F, -0.3982F, -0.3221F, -1.1643F, -0.0159F));
    ...
    public void setupAnim(BeeQueenEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.segment1.getAllParts().forEach(ModelPart::resetPose);
        this.segment2.getAllParts().forEach(ModelPart::resetPose);
        this.segment3.getAllParts().forEach(ModelPart::resetPose);
