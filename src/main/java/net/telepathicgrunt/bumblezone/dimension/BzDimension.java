...
public class BzDimension extends Dimension
{
     ...
     * 
     * Returns a value between 0 and 1. 0 is noon. 0.25 is dusk. 0.5 is midnight. 0.75 is dawn.
     */
     ...
     * Returns fog color
     * 
     * What I done is made it be based on the day/night cycle so the fog will darken at night but brighten during day. calculateVanillaSkyPositioning returns a value which is between 0 and 1 for day/night and fogChangeSpeed is the range that
     * the fog color will cycle between.
     */
    @Override
	...
	if (Bumblezone.BzConfig.dayNightCycle.get()) {
	    ...
	    /*
	     * The sky will be turned to midnight when brightness is below 50 and the day/night cycle is off. This lets us get the full range of brightness by utilizing the default brightness that the current celestial time gives.
	     */
