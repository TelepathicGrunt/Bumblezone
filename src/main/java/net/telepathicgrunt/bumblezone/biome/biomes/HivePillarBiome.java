...
public final class HivePillarBiome extends BzBaseBiome
{
	...
	{
		super((new Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder<>(HONEY_SURFACE_BUILDER, HONEY_CONFIG)).precipitation(Biome.RainType.NONE).category(Biome.Category.JUNGLE).depth(5F).scale(0.0F).temperature(1.85F).downfall(0.5F).waterColor(15717979).waterFogColor(13210368).parent((String) null));
