...
public final class HiveWallBiome extends BzBaseBiome
{
	public HiveWallBiome()
	{
		...
		this.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, BzFeatures.HONEY_CRYSTAL_FEATURE.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withPlacement(BzPlacements.RANDOM_3D_UNDERGROUND_CHUNK_PLACEMENT.configure(new FrequencyConfig(7))));
