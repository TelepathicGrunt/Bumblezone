...
public final class HiveWallBiome extends BzBaseBiome
{
	public HiveWallBiome()
	{
		...
		this.addFeature(GenerationStage.Decoration.UNDERGROUND_STRUCTURES, BzFeatures.BEE_DUNGEON.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.NOPE.configure(IPlacementConfig.NO_PLACEMENT_CONFIG)));
