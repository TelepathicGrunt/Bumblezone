...
public class BzBaseBiome extends Biome {
    ...
    protected static final BlockState FILLED_POROUS_HONEYCOMB = BzBlocksInit.FILLED_POROUS_HONEYCOMB.getDefaultState();
    protected static final BlockState POROUS_HONEYCOMB = BzBlocksInit.POROUS_HONEYCOMB.getDefaultState();
