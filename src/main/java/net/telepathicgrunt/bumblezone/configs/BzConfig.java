...
public class BzConfig {
    ...
    @Comment(value="Show the orangish particles when you get Wrath of the Hive\n" +
            "after you angered the bees in the Bumblezone dimension." +
            " from Filled Porous Honey blocks, or drink Honey Bottles.")
    public boolean showWrathOfTheHiveParticles = true;

    @Comment(value="Turn off or on the ability to get Wrath of the Hive effect.\n" +
            "\n" +
    ...
    @Comment(value="How far away the bee can be to become angry and hunt you down if\n" +
    ...
    @Comment(value="How long bees will keep their effects for (speed, absorption, strength).\n" +
            "\n" +
    ...
    @Comment(value="How fast bees move along the ground (Not while flying).\n" +
    ...
    @Comment(value="How much extra unrecoverable health boost the bees gets.")
    public int absorptionBoostLevel = 2;

    @Comment(value="How strong the bees attacks become.\n" +
    ...
    @Comment(value=" Determines how the coordinates gets translated when entering\n" +
    ...
    @Comment(value="Determines if the day/night cycle active in the Bumblezone dimension.\n" +
    ...
    @Comment(value="How bright the fog is in the Bumblezone dimension. \n" +
    ...
    @Comment(value="Makes leaving The Bumblezone dimension always places you back\n "
