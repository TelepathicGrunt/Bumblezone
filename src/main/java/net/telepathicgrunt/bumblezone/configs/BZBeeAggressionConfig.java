...
public class BZBeeAggressionConfig {
    ...
    @Comment(value = "Turn off or on the ability to get Wrath of the Hive effect from certain actions.\n" +
            "\n" +
    ...
    @ConfigEntry.Gui.Tooltip(count = 4)
    @Comment(value = "How long entities will keep Protection of the Hive effect after feeding bees\n" +
    ...
    @Comment(value = "How much extra health bees get that always instantly regenerates.\n" +
