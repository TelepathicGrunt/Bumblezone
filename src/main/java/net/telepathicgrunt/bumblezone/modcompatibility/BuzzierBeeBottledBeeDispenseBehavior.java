...
public class BuzzierBeeBottledBeeDispenseBehavior extends DefaultDispenseItemBehavior
{
	...
	public ItemStack dispenseStack(IBlockSource source, ItemStack stack)
	{
		...
		{
			world.setBlockState(position, BzBlocks.HONEYCOMB_LARVA.get().getDefaultState().with(HoneycombBrood.FACING, blockstate.get(EmptyHoneycombBrood.FACING)).with(HoneycombBrood.STAGE, Integer.valueOf(0)));
			stack.shrink(1);
