...
public record BzRegisterArmorProviderEvent(BiConsumer<Item, ArmorModelProvider> registrar) {

    public static final EventHandler<BzRegisterArmorProviderEvent> EVENT = new EventHandler<>();
