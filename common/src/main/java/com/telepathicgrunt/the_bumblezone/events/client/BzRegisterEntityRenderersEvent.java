...
public record BzRegisterEntityRenderersEvent(Registrar registrar) {

    public static final EventHandler<BzRegisterEntityRenderersEvent> EVENT = new EventHandler<>();
