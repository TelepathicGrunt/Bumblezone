...
public record BzRegisterDataSerializersEvent(BiConsumer<Identifier, EntityDataSerializer<?>> registrar) {

    public static final EventHandler<BzRegisterDataSerializersEvent> EVENT = new EventHandler<>();

    public void register(Identifier id, EntityDataSerializer<?> serializer) {
