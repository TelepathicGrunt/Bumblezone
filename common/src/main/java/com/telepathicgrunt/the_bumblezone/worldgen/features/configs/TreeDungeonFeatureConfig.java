...
public class TreeDungeonFeatureConfig extends NbtFeatureConfig implements FeatureConfiguration {
    public static final Codec<TreeDungeonFeatureConfig> CODEC = RecordCodecBuilder.create((configInstance) -> configInstance.group(
            Identifier.CODEC.fieldOf("tree_configured_feature").forGetter(nbtFeatureConfig -> nbtFeatureConfig.treeConfiguredFeature),
            Identifier.CODEC.fieldOf("processors").forGetter(nbtFeatureConfig -> nbtFeatureConfig.processor),
            Identifier.CODEC.fieldOf("post_processors").orElse(Identifier.fromNamespaceAndPath("minecraft", "empty")).forGetter(nbtFeatureConfig -> nbtFeatureConfig.postProcessor),
            Codec.mapPair(Identifier.CODEC.fieldOf("identifier"), ExtraCodecs.POSITIVE_INT.fieldOf("weight")).codec().listOf().fieldOf("nbt_entries").forGetter(nbtFeatureConfig -> nbtFeatureConfig.nbtResourcelocationsAndWeights),
    ...
    public final Identifier treeConfiguredFeature;

    public TreeDungeonFeatureConfig(Identifier treeConfiguredFeature,
