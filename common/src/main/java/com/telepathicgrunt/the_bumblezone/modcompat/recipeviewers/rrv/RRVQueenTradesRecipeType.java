...
public class RRVQueenTradesRecipeType implements ReliableClientRecipeType {
    ...
    public static final Identifier CATEGORY_ICON = Identifier.fromNamespaceAndPath("the_bumblezone", "textures/gui/bee_queen_trades.png");
    public static final Identifier TAG_ICON = Identifier.fromNamespaceAndPath("the_bumblezone", "textures/gui/tag_icon.png");
    ...
    public @Nullable Identifier getGuiTexture() {
        return Identifier.fromNamespaceAndPath(Bumblezone.MODID, "textures/gui/queen_trades_layout.png");
    }
