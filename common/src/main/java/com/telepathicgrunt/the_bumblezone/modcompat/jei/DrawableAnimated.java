...
public class DrawableAnimated implements IDrawableAnimated {
    ...
    private static StartDirection invert(StartDirection startDirection) {
    ...
    public DrawableAnimated(IDrawableStatic drawable, int ticksPerCycle, StartDirection startDirection, boolean inverted) {
        final StartDirection animationStartDirection;
        if (inverted) {
        ...
        if (animationStartDirection == StartDirection.TOP || animationStartDirection == StartDirection.BOTTOM) {
