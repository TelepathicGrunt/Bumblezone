...
public class QueenRandomizerTradesREICategory implements DisplayCategory<REIQueenRandomizerTradesInfo> {
	...
	public QueenRandomizerTradesREICategory() {
		this.icon = new QueenEggIconRenderer(ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "textures/gui/bee_queen_randomize_trades.png"));
	...
	public List<Widget> setupDisplay(REIQueenRandomizerTradesInfo display, Rectangle origin) {
		...
		widgets.add(Widgets.createTexturedWidget(ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "textures/gui/queen_randomizer_trades_layout.png"), new Rectangle(bounds.getX(), bounds.getY(), RECIPE_WIDTH, RECIPE_HEIGHT)));
