...
//		widgets.add(new TextureWidget(Identifier.fromNamespaceAndPath(Bumblezone.MODID, "textures/gui/recipe_viewer/queen_randomizer_trades_layout.png"), 0, 0, getDisplayWidth(), getDisplayHeight(), 0, 0));
//
