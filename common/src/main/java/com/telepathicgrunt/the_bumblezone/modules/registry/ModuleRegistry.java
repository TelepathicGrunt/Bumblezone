...
public class ModuleRegistry {
    ...
    public static final ModuleHolder<FlyingSpeedModule> FLYING_SPEED = ModuleHelperService.INSTANCE.createHolder(FlyingSpeedModule.SERIALIZER);
    public static final ModuleHolder<LivingEntityDataModule> LIVING_ENTITY_DATA = ModuleHelperService.INSTANCE.createHolder(LivingEntityDataModule.SERIALIZER);
    public static final ModuleHolder<EntityPosAndDimModule> ENTITY_POS_AND_DIM = ModuleHelperService.INSTANCE.createHolder(EntityPosAndDimModule.SERIALIZER);
    public static final ModuleHolder<PlayerDataModule> PLAYER_DATA = ModuleHelperService.INSTANCE.createHolder(PlayerDataModule.SERIALIZER);
