...
public class ModuleRegistry {
    ...
    public static final ModuleHolder<FlyingSpeedModule> FLYING_SPEED = RegistrationService.INSTANCE.createHolder(FlyingSpeedModule.SERIALIZER);
    public static final ModuleHolder<LivingEntityDataModule> LIVING_ENTITY_DATA = RegistrationService.INSTANCE.createHolder(LivingEntityDataModule.SERIALIZER);
    public static final ModuleHolder<EntityPosAndDimModule> ENTITY_POS_AND_DIM = RegistrationService.INSTANCE.createHolder(EntityPosAndDimModule.SERIALIZER);
    public static final ModuleHolder<PlayerDataModule> PLAYER_DATA = RegistrationService.INSTANCE.createHolder(PlayerDataModule.SERIALIZER);
