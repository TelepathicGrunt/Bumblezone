...
public class Bumblezone {
    ...
    // Note to self, use -XX:+AllowEnhancedClassRedefinition  arg with JetBrainsRuntime SDK (JBRSDK) + Single HotSwap Plugin to enable hotswapping goodness.
    ...
    public static void init() {
        ...
        PlayerItemUseOnBlockEvent.EVENT_HIGH.addListener(PlayerInteractivity::disableBlockPlacingOn);
        ...
        EntityAttackedEvent.EVENT_HIGH.addListener(HiveLifelineEnchantment::entityHurtEvent);
        ...
        BzBiomeHeightRegistry.BiomeTerrainEntries.init();
