...
public class DispenserItemSetup {
    ...
    public static void setupDispenserBehaviors() {
        ...
        HoneyBottleDispenseBehavior.DEFAULT_HONEY_BOTTLE_DISPENSE_BEHAVIOR =
                DispenserBlockInvoker.bumblezone$getDISPENSER_REGISTRY().get(Items.HONEY_BOTTLE);

        GlassBottleDispenseBehavior.DEFAULT_GLASS_BOTTLE_DISPENSE_BEHAVIOR =
                DispenserBlockInvoker.bumblezone$getDISPENSER_REGISTRY().get(Items.GLASS_BOTTLE);

        EmptyBucketDispenseBehavior.DEFAULT_EMPTY_BUCKET_DISPENSE_BEHAVIOR =
                DispenserBlockInvoker.bumblezone$getDISPENSER_REGISTRY().get(Items.BUCKET);

        FlintAndSteelDispenseBehavior.DEFAULT_DISPENSE_BEHAVIOR =
                DispenserBlockInvoker.bumblezone$getDISPENSER_REGISTRY().get(Items.FLINT_AND_STEEL);

        StringDispenseBehavior.DEFAULT_STRING_DISPENSE_BEHAVIOR =
                DispenserBlockInvoker.bumblezone$getDISPENSER_REGISTRY().get(Items.STRING);
