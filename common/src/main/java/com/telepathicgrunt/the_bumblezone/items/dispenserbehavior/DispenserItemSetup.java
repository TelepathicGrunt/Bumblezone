...
public class DispenserItemSetup {
    ...
    public static void setupDispenserBehaviors() {
        ...
        HoneyBottleDispenseBehavior.DEFAULT_HONEY_BOTTLE_DISPENSE_BEHAVIOR =
                ((DispenserBlockInvoker) Blocks.DISPENSER).bumblezone$invokeGetDispenseMethod(new ItemStack(Items.HONEY_BOTTLE));

        GlassBottleDispenseBehavior.DEFAULT_GLASS_BOTTLE_DISPENSE_BEHAVIOR =
                ((DispenserBlockInvoker) Blocks.DISPENSER).bumblezone$invokeGetDispenseMethod(new ItemStack(Items.GLASS_BOTTLE));

        EmptyBucketDispenseBehavior.DEFAULT_EMPTY_BUCKET_DISPENSE_BEHAVIOR =
                ((DispenserBlockInvoker) Blocks.DISPENSER).bumblezone$invokeGetDispenseMethod(new ItemStack(Items.BUCKET));

        FlintAndSteelDispenseBehavior.DEFAULT_DISPENSE_BEHAVIOR =
                ((DispenserBlockInvoker) Blocks.DISPENSER).bumblezone$invokeGetDispenseMethod(new ItemStack(Items.FLINT_AND_STEEL));

        StringDispenseBehavior.DEFAULT_STRING_DISPENSE_BEHAVIOR =
                ((DispenserBlockInvoker) Blocks.DISPENSER).bumblezone$invokeGetDispenseMethod(new ItemStack(Items.STRING));
