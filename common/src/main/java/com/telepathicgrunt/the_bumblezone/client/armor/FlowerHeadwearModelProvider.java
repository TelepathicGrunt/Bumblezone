...
public class FlowerHeadwearModelProvider implements ArmorModelProvider {
    ...
    @Override
    public @NotNull HumanoidModel<? super HumanoidRenderState> getModel(ItemStack stack, @Nullable EquipmentSlot equipmentSlot, HumanoidModel<? super HumanoidRenderState> original) {
        if (this.model == null) {
