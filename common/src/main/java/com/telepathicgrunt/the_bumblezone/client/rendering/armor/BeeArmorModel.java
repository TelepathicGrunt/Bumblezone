...
public class BeeArmorModel extends HumanoidModel<HumanoidRenderState> {
    ...
    public static LayerDefinition createVariant1Head() {
        ...
        head.addOrReplaceChild("antenna_1", CubeListBuilder.create().texOffs(28, 82).addBox(1.5F, -14.0F, 6.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
        ...
        head.addOrReplaceChild("antenna_2", CubeListBuilder.create().texOffs(40, 82).addBox(-3.0F, -12.5F, 1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
    ...
    public static LayerDefinition createVariant1Chestplate() {
        ...
        PartDefinition armorBody = root.addOrReplaceChild("armorBody", CubeListBuilder.create().texOffs(0, 21).addBox(-4.5F, 4.0F, -2.5F, 9.0F, 8.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        armorBody.addOrReplaceChild("stinger_r1", CubeListBuilder.create().texOffs(36, 82).addBox(-1.0F, 6.5F, -9.25F, 2.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.0908F, 0.0F, 0.0F));

        PartDefinition left_wing = armorBody.addOrReplaceChild("left_wing", CubeListBuilder.create(), PartPose.offset(2.5F, 3.0F, 2.5F));

        left_wing.addOrReplaceChild("left_wing_parts", CubeListBuilder.create().texOffs(12, 91).addBox(-1.0F, -10.25F, 3.75F, 0.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(7, 89).addBox(-1.0F, -7.25F, -1.25F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.85F, -1.775F, -2.45F, -0.8013F, 0.9461F, 1.5729F));

        PartDefinition right_wing = armorBody.addOrReplaceChild("right_wing", CubeListBuilder.create(), PartPose.offset(-2.5F, 4.0F, 2.5F));

        right_wing.addOrReplaceChild("right_wing_parts", CubeListBuilder.create().texOffs(12, 91).mirror().addBox(1.0F, -10.25F, 3.75F, 0.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(10, 93).mirror().addBox(1.0F, -11.25F, 1.75F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(10, 91).mirror().addBox(1.0F, -9.25F, 1.75F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(9, 93).mirror().addBox(1.0F, -10.25F, 0.75F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(8, 91).mirror().addBox(1.0F, -9.25F, -0.25F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(11, 90).mirror().addBox(1.0F, -7.25F, 2.75F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(10, 89).mirror().addBox(1.0F, -6.25F, 1.75F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(8, 87).mirror().addBox(1.0F, -5.25F, -0.25F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(7, 89).mirror().addBox(1.0F, -7.25F, -1.25F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.85F, -2.775F, -2.45F, -0.8013F, -0.9461F, -1.5729F));

        root.addOrReplaceChild("armorRightArm", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        root.addOrReplaceChild("armorLeftArm", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
    ...
    public static LayerDefinition createVariant1Leggings() {
        ...
        PartDefinition right_leg_main = root.addOrReplaceChild("right_leg", CubeListBuilder.create().addBox(0, 0, 0, 0, 0, 0, new CubeDeformation(0.0F).extend(-0.1F)), PartPose.offset(-1.9F, 12.0F, 0.0F));
        ...
        right_leg.addOrReplaceChild("pollen_right", CubeListBuilder.create().texOffs(40, 37).addBox(1.005F, 1.25F, -2.995F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 0.0F, 0.0F));

        PartDefinition left_leg_main = root.addOrReplaceChild("left_leg", CubeListBuilder.create().addBox(0, 0, 0, 0, 0, 0, new CubeDeformation(0.0F).extend(-0.1F)), PartPose.offset(1.9F, 12.0F, 0.0F));
        ...
        left_leg.addOrReplaceChild("pollen_left", CubeListBuilder.create().texOffs(0, 50).addBox(3.0F, 1.25F, -3.0F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 0.0F, 0.0F));
    ...
    public static LayerDefinition createVariant1Boots() {
        ...
        PartDefinition right_leg_main = root.addOrReplaceChild("right_leg", CubeListBuilder.create().addBox(0, 0, 0, 0, 0, 0, new CubeDeformation(0.0F)), PartPose.offset(-1.9F, 12.0F, 0.0F));
        ...
        PartDefinition left_leg_main = root.addOrReplaceChild("left_leg", CubeListBuilder.create().addBox(0, 0, 0, 0, 0, 0, new CubeDeformation(0.0F)), PartPose.offset(1.9F, 12.0F, 0.0F));
    ...
    public static LayerDefinition createVariant2Head() {
        ...
        PartDefinition head = root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -9F, -6.0F, 10.0F, 4F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        PartDefinition antennas = head.addOrReplaceChild("antennas", CubeListBuilder.create(), PartPose.offset(0.0F, -3.0F, 3.0F));

        antennas.addOrReplaceChild("antennaEnd_1", CubeListBuilder.create().texOffs(28, 82).addBox(1.5F, -14.0F, 6.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(20, 82).addBox(-3.5F, -14.0F, 6.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(16, 89).addBox(2.0F, -12.0F, 6.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        antennas.addOrReplaceChild("antennaEnd_2", CubeListBuilder.create().texOffs(40, 82).addBox(-3.0F, -12.5F, 1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
    ...
    public static LayerDefinition createVariant2Chestplate() {
        ...
        PartDefinition armorBody = root.addOrReplaceChild("armorBody", CubeListBuilder.create().texOffs(0, 19).addBox(-4.5F, 0.0F, -2.5F, 9.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.25F, 0.0F));

        armorBody.addOrReplaceChild("stinger_r1", CubeListBuilder.create().texOffs(36, 82).addBox(-0.5F, 0.5F, 0.75F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 12.0F, 0.0F, 1.5708F, 0.0F, 0.0F));

        PartDefinition left_wing = armorBody.addOrReplaceChild("left_wing", CubeListBuilder.create(), PartPose.offsetAndRotation(2.0946F, 2.9565F, 2.2991F, -0.3523F, -0.0283F, -0.6134F));

        left_wing.addOrReplaceChild("left_wing_parts", CubeListBuilder.create().texOffs(13, 77).addBox(-1.0F, -10.25F, 3.75F, 0.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition right_wing = armorBody.addOrReplaceChild("right_wing", CubeListBuilder.create(), PartPose.offsetAndRotation(-2.0946F, 2.9565F, 2.2991F, -0.3523F, 0.0283F, 0.6134F));

        right_wing.addOrReplaceChild("right_wing_parts", CubeListBuilder.create().texOffs(13, 77).mirror().addBox(1.0F, -10.25F, 3.75F, 0.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(9, 85).mirror().addBox(1.0F, -9.25F, 1.75F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(10, 82).mirror().addBox(1.0F, -11.25F, 1.75F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(6, 86).mirror().addBox(1.0F, -10.25F, 0.75F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(6, 86).mirror().addBox(1.0F, -6.25F, 1.75F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(3, 86).mirror().addBox(1.0F, -7.25F, 2.75F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(12, 85).mirror().addBox(1.0F, -9.25F, -0.25F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 77).mirror().addBox(1.0F, -5.25F, -0.25F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 85).mirror().addBox(1.0F, -7.25F, -1.25F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.8446F, -2.9565F, -2.8991F, -0.9071F, -0.8312F, -1.7963F));
