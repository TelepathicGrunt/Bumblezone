...
public class BeeArmorModel extends HumanoidModel<LivingEntity> {
    ...
    public static final List<ModelLayerLocation> VARIANT_1_ARMOR_LAYER_LOCATIONS = Arrays.asList(
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "bee_armor_1"), "helmet"),
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "bee_armor_1"), "chestplate"),
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "bee_armor_1"), "leggings"),
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "bee_armor_1"), "boots")
    );
    public static final List<ModelLayerLocation> VARIANT_2_ARMOR_LAYER_LOCATIONS = Arrays.asList(
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "bee_armor_2"), "helmet"),
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "bee_armor_2"), "chestplate"),
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "bee_armor_2"), "leggings"),
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "bee_armor_2"), "boots")
    );
