...
public class BeehemothControls {
    public static final KeyMapping KEY_BIND_BEEHEMOTH_DOWN = KeyMappingService.INSTANCE.createBeehemothKey(
    ...
    public static final KeyMapping KEY_BIND_BEEHEMOTH_UP = KeyMappingService.INSTANCE.createBeehemothKey(
