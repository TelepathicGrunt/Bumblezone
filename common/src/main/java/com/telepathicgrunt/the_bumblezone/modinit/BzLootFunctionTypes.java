...
public class BzLootFunctionTypes {
    ...
    public static final ResourcefulRegistry<LootItemFunctionType> LOOT_ITEM_FUNCTION_TYPE = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.LOOT_FUNCTION_TYPE, Bumblezone.MODID);
