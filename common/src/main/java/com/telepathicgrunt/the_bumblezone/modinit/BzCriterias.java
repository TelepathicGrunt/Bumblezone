...
public class BzCriterias {
    ...
    public static void registerCriteriaTriggers() {
        RegistrationService.INSTANCE.register(BEE_BREEDING_TRIGGER);
        RegistrationService.INSTANCE.register(BEENERGIZED_MAXED_TRIGGER);
        RegistrationService.INSTANCE.register(BEE_CANNON_FULL_TRIGGER);
        RegistrationService.INSTANCE.register(BEE_DROP_POLLEN_PUFF_TRIGGER);
        RegistrationService.INSTANCE.register(BEE_FED_TRIGGER);
        RegistrationService.INSTANCE.register(BEE_SAVED_BY_STINGER_TRIGGER);
        RegistrationService.INSTANCE.register(BEE_STINGER_PARALYZE_TRIGGER);
        RegistrationService.INSTANCE.register(BEE_STINGER_SHOOTER_TRIGGER);
        RegistrationService.INSTANCE.register(BEE_QUEEN_FIRST_TRADE_TRIGGER);
        RegistrationService.INSTANCE.register(BEEHIVE_CRAFTED_TRIGGER);
        RegistrationService.INSTANCE.register(BUMBLE_BEE_CHESTPLATE_MAX_FLIGHT_TRIGGER);
        RegistrationService.INSTANCE.register(BUZZING_BRIEFCASE_FULL_TRIGGER);
        RegistrationService.INSTANCE.register(BUZZING_BRIEFCASE_HEAL_TRIGGER);
        RegistrationService.INSTANCE.register(BUZZING_BRIEFCASE_RELEASE_TRIGGER);
        RegistrationService.INSTANCE.register(CARPENTER_BEE_BOOTS_MINED_BLOCKS_TRIGGER);
        RegistrationService.INSTANCE.register(CARPENTER_BEE_BOOTS_WALL_HANGING_TRIGGER);
        RegistrationService.INSTANCE.register(CARVE_WAX_TRIGGER);
        RegistrationService.INSTANCE.register(CLEANUP_HONEY_WEB_TRIGGER);
        RegistrationService.INSTANCE.register(CLEANUP_STICKY_HONEY_RESIDUE_TRIGGER);
        RegistrationService.INSTANCE.register(COMB_CUTTER_EXTRA_DROPS_TRIGGER);
        RegistrationService.INSTANCE.register(CRYSTAL_CANNON_FULL_TRIGGER);
        RegistrationService.INSTANCE.register(BEE_HIT_WRATH_OF_THE_HIVE_TRIGGER);
        RegistrationService.INSTANCE.register(ENCHANT_CRYSTALLINE_FLOWER_TRIGGER);
        RegistrationService.INSTANCE.register(ESSENCE_EVENT_REWARD_TRIGGER);
        RegistrationService.INSTANCE.register(EXTEND_STRING_CURTAIN_TRIGGER);
        RegistrationService.INSTANCE.register(FALLING_ON_POLLEN_BLOCK_TRIGGER);
        RegistrationService.INSTANCE.register(FLOWER_HEADWEAR_WRATH_STRUCTURE_TRIGGER);
        RegistrationService.INSTANCE.register(FOOD_REMOVED_WRATH_OF_THE_HIVE_TRIGGER);
        RegistrationService.INSTANCE.register(GETTING_PROTECTION_TRIGGER);
        RegistrationService.INSTANCE.register(GROW_CRYSTALLINE_FLOWER_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_BEE_LEGGINGS_FLOWER_POLLEN_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_BEE_LEGGINGS_POLLEN_REMOVAL_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_BOTTLE_DRANK_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_BUCKET_BEE_GROW_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_BUCKET_BEE_LOVE_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_BUCKET_BROOD_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_COCOON_SILK_TOUCH_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_COMPASS_USE_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_CRYSTAL_SHIELD_BLOCK_INEFFECTIVELY_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_PERMISSION_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_SLIME_BRED_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_SLIME_CREATION_TRIGGER);
        RegistrationService.INSTANCE.register(HONEY_SLIME_HARVEST_TRIGGER);
        RegistrationService.INSTANCE.register(IS_NEAR_BEEHIVE_TRIGGER);
        RegistrationService.INSTANCE.register(KILLED_COUNTER_TRIGGER);
        RegistrationService.INSTANCE.register(LIGHT_SOUL_SUPER_CANDLE_TRIGGER);
        RegistrationService.INSTANCE.register(POLLEN_PUFF_MOOSHROOM_TRIGGER);
        RegistrationService.INSTANCE.register(POLLEN_PUFF_FIREBALL_TRIGGER);
        RegistrationService.INSTANCE.register(POLLEN_PUFF_HIT_TRIGGER);
        RegistrationService.INSTANCE.register(POLLEN_PUFF_PANDA_TRIGGER);
        RegistrationService.INSTANCE.register(POLLEN_PUFF_POLLINATED_BEE_TRIGGER);
        RegistrationService.INSTANCE.register(POLLEN_PUFF_POLLINATED_TALL_FLOWER_TRIGGER);
        RegistrationService.INSTANCE.register(POLLEN_PUFF_SPAWN_FLOWERS_TRIGGER);
        RegistrationService.INSTANCE.register(PROJECTILE_LIGHT_INSTANT_POTION_CANDLE_TRIGGER);
        RegistrationService.INSTANCE.register(PROTECTION_OF_THE_HIVE_DEFENSE_TRIGGER);
        RegistrationService.INSTANCE.register(BEE_QUEEN_TRADING_TRIGGER);
        RegistrationService.INSTANCE.register(QUEEN_BEEHEMOTH_TRIGGER);
        RegistrationService.INSTANCE.register(ROOTMIN_FLOWER_SWAP_TRIGGER);
        RegistrationService.INSTANCE.register(ROYAL_JELLY_BLOCK_PISTON_TRIGGER);
        RegistrationService.INSTANCE.register(SEMPITERNAL_SANCTUM_ENTER_WITH_BEE_ESSENCE_TRIGGER);
        RegistrationService.INSTANCE.register(SENTRY_WATCHER_SPAWN_EGG_USED_TRIGGER);
        RegistrationService.INSTANCE.register(STINGER_SPEAR_KILLED_WITH_WITHER_TRIGGER);
        RegistrationService.INSTANCE.register(STINGER_SPEAR_LONG_RANGE_KILL_TRIGGER);
        RegistrationService.INSTANCE.register(STINGER_SPEAR_PARALYZE_BOSS_TRIGGER);
        RegistrationService.INSTANCE.register(STINGER_SPEAR_PARALYZING_TRIGGER);
        RegistrationService.INSTANCE.register(STINGER_SPEAR_POISONING_TRIGGER);
        RegistrationService.INSTANCE.register(STINGLESS_BEE_HELMET_SUPER_SIGHT_TRIGGER);
        RegistrationService.INSTANCE.register(SUGAR_WATER_NEXT_TO_SUGAR_CANE_TRIGGER);
        RegistrationService.INSTANCE.register(TARGET_ADVANCEMENT_DONE_TRIGGER);
        RegistrationService.INSTANCE.register(TELEPORT_OUT_OF_BUMBLEZONE_TRIGGER);
        RegistrationService.INSTANCE.register(TELEPORT_TO_BUMBLEZONE_PEARL_TRIGGER);
        RegistrationService.INSTANCE.register(TELEPORT_TO_BUMBLEZONE_PISTON_TRIGGER);
        RegistrationService.INSTANCE.register(TRIGGER_REDSTONE_HONEY_WEB_TRIGGER);
        RegistrationService.INSTANCE.register(VARIANT_BEE_BRIEFCASE_CAPTURE_TRIGGER);
    }
}
