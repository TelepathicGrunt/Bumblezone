...
public final class BzStructurePlacementType {
	public static final ResourcefulRegistry<StructurePlacementType<?>> STRUCTURE_PLACEMENT_TYPE = RegistrationService.INSTANCE.create(BuiltInRegistries.STRUCTURE_PLACEMENT, Bumblezone.MODID);
