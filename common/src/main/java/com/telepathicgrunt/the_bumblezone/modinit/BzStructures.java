...
public class BzStructures {
    ...
    public static final ResourcefulRegistry<StructureType<?>> STRUCTURES = RegistrationService.INSTANCE.create(BuiltInRegistries.STRUCTURE_TYPE, Bumblezone.MODID);
