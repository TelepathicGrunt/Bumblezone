...
public class BzBlockEntities {
    public static final ResourcefulRegistry<BlockEntityType<?>> BLOCK_ENTITIES = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.BLOCK_ENTITY_TYPE, Bumblezone.MODID);
