...
public class BzDimension {
    ...
    public static final ResourcefulRegistry<Codec<? extends ChunkGenerator>> CHUNK_GENERATOR = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.CHUNK_GENERATOR, Bumblezone.MODID);
    public static final ResourcefulRegistry<Codec<? extends BiomeSource>> BIOME_SOURCE = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.BIOME_SOURCE, Bumblezone.MODID);
    public static final ResourcefulRegistry<Codec<? extends DensityFunction>> DENSITY_FUNCTIONS = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.DENSITY_FUNCTION_TYPE, Bumblezone.MODID);
