...
public class BzTags {
    ...
    public static final TagKey<Block> BLOCKS_THAT_HONEYCOMB_HOLE_CAN_CARVE = TagKey.create(Registries.BLOCK, new ResourceLocation(Bumblezone.MODID, "worldgen_checks/blocks_that_honeycomb_hole_can_carve"));
    public static final TagKey<Block> BLOCKS_THAT_HONEYCOMB_HOLE_AIR_CAN_CARVE = TagKey.create(Registries.BLOCK, new ResourceLocation(Bumblezone.MODID, "worldgen_checks/blocks_that_honeycomb_hole_air_can_carve"));
    ...
    public static final TagKey<Block> WEB_BRIDGE_VALID_SURFACES = TagKey.create(Registries.BLOCK, new ResourceLocation(Bumblezone.MODID, "web_bridge/valid_surfaces"));
    ...
    public static final TagKey<Block> HANGING_GARDEN_ALLOWED_FLOWERS_BLOCKS = TagKey.create(Registries.BLOCK, new ResourceLocation(Bumblezone.MODID, "hanging_garden/allowed_flowers"));
    public static final TagKey<Block> HANGING_GARDEN_FORCED_DISALLOWED_FLOWERS_BLOCKS = TagKey.create(Registries.BLOCK, new ResourceLocation(Bumblezone.MODID, "hanging_garden/forced_disallowed_flowers"));
    public static final TagKey<Block> HANGING_GARDEN_ALLOWED_TALL_FLOWERS_BLOCKS = TagKey.create(Registries.BLOCK, new ResourceLocation(Bumblezone.MODID, "hanging_garden/allowed_tall_flowers"));
    public static final TagKey<Block> HANGING_GARDEN_FORCED_DISALLOWED_TALL_FLOWERS_BLOCKS = TagKey.create(Registries.BLOCK, new ResourceLocation(Bumblezone.MODID, "hanging_garden/forced_disallowed_tall_flowers"));
    ...
    public static final TagKey<Block> SUGAR_WATER_GROWS_PLANT_FASTER = TagKey.create(Registries.BLOCK, new ResourceLocation(Bumblezone.MODID, "sugar_water/grows_plant_faster"));
    ...
    public static final TagKey<Block> DISABLE_BLOCK_PLACING_ON = TagKey.create(Registries.BLOCK, new ResourceLocation(Bumblezone.MODID, "disable_block_placing_on"));
