...
public class BzTags {
    ...
    public static final TagKey<Block> HONEY_BEE_BOOTS_REMOVES_POLLEN_BLOCKS = TagKey.create(Registries.BLOCK, new ResourceLocation(Bumblezone.MODID, "honey_bee_leggings/removes_pollen"));
    ...
    public static final TagKey<Block> ROOTMIN_FLORAL_MEADOW_FLOWERS = TagKey.create(Registries.BLOCK, new ResourceLocation(Bumblezone.MODID, "biomes/floral_meadow_rootmin_flowers"));
    ...
    public static final TagKey<Item> FLOWER_HEADWEAR_REPAIR_ITEMS = TagKey.create(Registries.ITEM, new ResourceLocation(Bumblezone.MODID, "repair_items/flower_headwear"));
    ...
    public static final TagKey<EntityType<?>> PARALYZED_IMMUNE = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(Bumblezone.MODID, "paralyzed/immune"));
    ...
    public static final TagKey<EntityType<?>> CALMING_ALLOW_ANGER_THROUGH = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(Bumblezone.MODID, "essence/calming/allow_anger_through"));
    public static final TagKey<EntityType<?>> KNOWING_ENTITY_PREVENT_HIGHLIGHTING = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(Bumblezone.MODID, "essence/knowing/prevent_highlighting"));
    public static final TagKey<EntityType<?>> KNOWING_ENTITY_FORCED_WHITE_HIGHLIGHT = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(Bumblezone.MODID, "essence/knowing/forced_white_highlight"));
    public static final TagKey<EntityType<?>> KNOWING_ENTITY_FORCED_PURPLE_HIGHLIGHT = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(Bumblezone.MODID, "essence/knowing/forced_purple_highlight"));
    public static final TagKey<EntityType<?>> KNOWING_ENTITY_FORCED_CYAN_HIGHLIGHT = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(Bumblezone.MODID, "essence/knowing/forced_cyan_highlight"));
    public static final TagKey<EntityType<?>> KNOWING_ENTITY_FORCED_GREEN_HIGHLIGHT = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(Bumblezone.MODID, "essence/knowing/forced_green_highlight"));
    public static final TagKey<EntityType<?>> KNOWING_ENTITY_FORCED_YELLOW_HIGHLIGHT = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(Bumblezone.MODID, "essence/knowing/forced_yellow_highlight"));
    public static final TagKey<EntityType<?>> KNOWING_ENTITY_FORCED_ORANGE_HIGHLIGHT = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(Bumblezone.MODID, "essence/knowing/forced_orange_highlight"));
    public static final TagKey<EntityType<?>> KNOWING_ENTITY_FORCED_RED_HIGHLIGHT = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(Bumblezone.MODID, "essence/knowing/forced_red_highlight"));
    ...
    public static final TagKey<Structure> NO_GIANT_SPIKES = TagKey.create(Registries.STRUCTURE, new ResourceLocation(Bumblezone.MODID, "no_giant_spikes"));
    ...
    public static final TagKey<Structure> KNOWING_PREVENT_DISPLAYING_NAME = TagKey.create(Registries.STRUCTURE, new ResourceLocation(Bumblezone.MODID, "essence/knowing/prevent_displaying_name"));
