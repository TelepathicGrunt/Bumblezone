...
public class BzPredicates {
    public static final ResourcefulRegistry<PosRuleTestType<?>> POS_RULE_TEST = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.POS_RULE_TEST, Bumblezone.MODID);
    public static final ResourcefulRegistry<RuleTestType<?>> RULE_TEST = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.RULE_TEST, Bumblezone.MODID);
