...
public class BzPredicates {
    public static final ResourcefulRegistry<PosRuleTestType<?>> POS_RULE_TEST = RegistrationService.INSTANCE.create(BuiltInRegistries.POS_RULE_TEST, Bumblezone.MODID);
    public static final ResourcefulRegistry<RuleTestType<?>> RULE_TEST = RegistrationService.INSTANCE.create(BuiltInRegistries.RULE_TEST, Bumblezone.MODID);
