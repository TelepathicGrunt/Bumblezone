...
public class BzItems {
    ...
    public static final RegistryEntry<Item> MUSIC_DISC_RIVERS_OF_HONEY_MOSERAO = ITEMS.register("music_disc_rivers_of_honey_moserao", () -> new BzMusicDiscs(4, BzSounds.MUSIC_DISC_RIVERS_OF_HONEY_MOSERAO, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscTimeLengthRiversOfHoney, false));
