...
public class BzItems {
    ...
    public static final RegistryEntry<Item> WHITE_ESSENCE_BLOCK = ITEMS.register("white_essence_block", () -> new BlockItem(BzBlocks.WHITE_ESSENCE_BLOCK.get(), new Item.Properties().rarity(Rarity.EPIC)));
