...
public class BzItems {
    ...
    public static final RegistryEntry<Item> ROYAL_JELLY_BOTTLE = ITEMS.register("royal_jelly_bottle", () -> new RoyalJellyBottle((new Item.Properties().rarity(Rarity.EPIC)).craftRemainder(Items.GLASS_BOTTLE).food(new FoodProperties.Builder().nutrition(12).saturationModifier(1.0F).effect(new MobEffectInstance(MobEffects.SLOW_FALLING, 9600, 0), 1.0F).effect(new MobEffectInstance(MobEffects.JUMP, 9600, 3), 1.0F).effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 9600, 1), 1.0F).effect(new MobEffectInstance(BzEffects.BEENERGIZED.get(), 9600, 2), 1.0F).build()).stacksTo(16)));
    ...
    public static final RegistryEntry<Item> BEE_BREAD = ITEMS.register("bee_bread", () -> new BeeBread(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.1F).alwaysEdible().effect(new MobEffectInstance(BzEffects.BEENERGIZED.get(), 6000, 0), 1.0F).effect(new MobEffectInstance(MobEffects.CONFUSION, 120, 1), 1.0F).build())));
    public static final RegistryEntry<Item> BEE_SOUP = ITEMS.register("bee_soup", () -> new FoodBowlItem(new Item.Properties().craftRemainder(Items.BOWL).food(new FoodProperties.Builder().nutrition(12).saturationModifier(1.6F).effect(new MobEffectInstance(BzEffects.BEENERGIZED.get(), 12000, 1), 1.0F).effect(new MobEffectInstance(MobEffects.LEVITATION, 800, 0), 0.2F).effect(new MobEffectInstance(MobEffects.POISON, 800, 0), 0.2F).effect(new MobEffectInstance(MobEffects.SLOW_FALLING, 6000, 0), 0.2F).effect(new MobEffectInstance(MobEffects.LUCK, 18000, 0), 0.2F).effect(new MobEffectInstance(BzEffects.PARALYZED.get(), Math.min(BzGeneralConfigs.paralyzedMaxTickDuration, 200), 0), 0.2F).build())));
    ...
    public static final RegistryEntry<Item> STINGLESS_BEE_HELMET_1 = ITEMS.register("stingless_bee_helmet_1", () -> new StinglessBeeHelmet(BzArmorMaterials.BEE_MATERIAL.get(), ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.UNCOMMON), 1));
    public static final RegistryEntry<Item> STINGLESS_BEE_HELMET_2 = ITEMS.register("stingless_bee_helmet_2", () -> new StinglessBeeHelmet(BzArmorMaterials.BEE_MATERIAL.get(), ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.UNCOMMON), 2));
    public static final RegistryEntry<Item> BUMBLE_BEE_CHESTPLATE_1 = ITEMS.register("bumble_bee_chestplate_1", () -> new BumbleBeeChestplate(BzArmorMaterials.BEE_MATERIAL.get(), ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.UNCOMMON), false, 1));
    public static final RegistryEntry<Item> BUMBLE_BEE_CHESTPLATE_2 = ITEMS.register("bumble_bee_chestplate_2", () -> new BumbleBeeChestplate(BzArmorMaterials.BEE_MATERIAL.get(), ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.UNCOMMON), false, 2));
    public static final RegistryEntry<Item> TRANS_BUMBLE_BEE_CHESTPLATE_1 = ITEMS.register("bumble_bee_chestplate_trans_1", () -> new BumbleBeeChestplate(BzArmorMaterials.BEE_MATERIAL.get(), ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.UNCOMMON), true, 1));
    public static final RegistryEntry<Item> TRANS_BUMBLE_BEE_CHESTPLATE_2 = ITEMS.register("bumble_bee_chestplate_trans_2", () -> new BumbleBeeChestplate(BzArmorMaterials.BEE_MATERIAL.get(), ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.UNCOMMON), true, 2));
    public static final RegistryEntry<Item> HONEY_BEE_LEGGINGS_1 = ITEMS.register("honey_bee_leggings_1", () -> new HoneyBeeLeggings(BzArmorMaterials.BEE_MATERIAL.get(), ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.UNCOMMON), 1));
    public static final RegistryEntry<Item> HONEY_BEE_LEGGINGS_2 = ITEMS.register("honey_bee_leggings_2", () -> new HoneyBeeLeggings(BzArmorMaterials.BEE_MATERIAL.get(), ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.UNCOMMON), 2));
    public static final RegistryEntry<Item> CARPENTER_BEE_BOOTS_1 = ITEMS.register("carpenter_bee_boots_1", () -> new CarpenterBeeBoots(BzArmorMaterials.BEE_MATERIAL.get(), ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.UNCOMMON), 1));
    public static final RegistryEntry<Item> CARPENTER_BEE_BOOTS_2 = ITEMS.register("carpenter_bee_boots_2", () -> new CarpenterBeeBoots(BzArmorMaterials.BEE_MATERIAL.get(), ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.UNCOMMON), 2));
    ...
    public static final RegistryEntry<Item> MUSIC_DISC_BEE_WARE_OF_THE_TEMPLE = ITEMS.register("music_disc_bee_ware_of_the_temple", () -> new BzMusicDiscs(11, BzSounds.MUSIC_DISC_BEE_WARE_OF_THE_TEMPLE, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscTimeLengthBeeWareOfTheTemple, true));
    public static final RegistryEntry<Item> MUSIC_DISC_KNOWING_RENREN = ITEMS.register("music_disc_knowing_renren", () -> new BzMusicDiscs(10, BzSounds.MUSIC_DISC_KNOWING_RENREN, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscTimeLengthKnowing, false));
    public static final RegistryEntry<Item> MUSIC_DISC_RADIANCE_RENREN = ITEMS.register("music_disc_radiance_renren", () -> new BzMusicDiscs(9, BzSounds.MUSIC_DISC_RADIANCE_RENREN, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscTimeLengthRadiance, false));
    public static final RegistryEntry<Item> MUSIC_DISC_LIFE_RENREN = ITEMS.register("music_disc_life_renren", () -> new BzMusicDiscs(8, BzSounds.MUSIC_DISC_LIFE_RENREN, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscTimeLengthLife, false));
    public static final RegistryEntry<Item> MUSIC_DISC_A_LAST_FIRST_LAST = ITEMS.register("music_disc_a_last_first_last", () -> new BzMusicDiscs(7, BzSounds.MUSIC_DISC_A_LAST_FIRST_LAST_MONO, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscTimeAFirstALast, false));
