...
public class BzItems {
    ...
    public static final RegistryEntry<Item> VARIANT_BEE_SPAWN_EGG = ITEMS.register("variant_bee_spawn_egg", () -> new DispenserAddedSpawnEgg(BzEntities.VARIANT_BEE, 0xFFFFFF, 0xFFFFFF, (new Item.Properties())));
