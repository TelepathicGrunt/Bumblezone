...
public class BzItems {
    ...
    public static final RegistryEntry<Item> MUSIC_DISC_A_LAST_FIRST_LAST = ITEMS.register("music_disc_a_last_first_last", () -> new BzMusicDiscs((new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(BzJukeboxSongs.A_LAST_FIRST_LAST), true));
    public static final RegistryEntry<Item> MUSIC_DISC_DROWNING_IN_DESPAIR = ITEMS.register("music_disc_drowning_in_despair", () -> new BzMusicDiscs((new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(BzJukeboxSongs.DROWNING_IN_DESPAIR), true));
    public static final RegistryEntry<Item> MUSIC_DISC_BEENNA_BOX = ITEMS.register("music_disc_beenna_box", () -> new BzMusicDiscs((new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(BzJukeboxSongs.BEENNA_BOX), true));
