...
public class BzItems {
    ...
    public static final RegistryEntry<Item> MUSIC_DISC_DROWNING_IN_DESPAIR = ITEMS.register("music_disc_drowning_in_despair", () -> new BzMusicDiscs(6, BzSounds.MUSIC_DISC_DROWNING_IN_DESPAIR_MONO, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscDrowningInDespair, false));
    public static final RegistryEntry<Item> MUSIC_DISC_BEENNA_BOX = ITEMS.register("music_disc_beenna_box", () -> new BzMusicDiscs(5, BzSounds.MUSIC_DISC_BEENNA_BOX_MONO, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscBeennaBox, false));
