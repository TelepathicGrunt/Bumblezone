...
public class BzItems {
    ...
    public static final ResourcefulRegistry<Item> ITEMS = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.ITEM, Bumblezone.MODID);
    ...
    public static final RegistryEntry<Item> ROYAL_JELLY_BOTTLE = ITEMS.register("royal_jelly_bottle", () -> new RoyalJellyBottle((new Item.Properties().rarity(Rarity.EPIC)).craftRemainder(Items.GLASS_BOTTLE).food(BzFoodProperties.builder(12, 1.0F).effect(() -> new MobEffectInstance(MobEffects.SLOW_FALLING, 9600, 0), 1.0F).effect(() -> new MobEffectInstance(MobEffects.JUMP, 9600, 3), 1.0F).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 9600, 1), 1.0F).effect(() -> new MobEffectInstance(BzEffects.BEENERGIZED.get(), 9600, 2), 1.0F).build()).stacksTo(16)));
    ...
    public static final RegistryEntry<Item> BEE_BREAD = ITEMS.register("bee_bread", () -> new BeeBread(new Item.Properties().food(BzFoodProperties.builder(6, 0.1F).alwaysEat().effect(() -> new MobEffectInstance(BzEffects.BEENERGIZED.get(), 6000, 0), 1.0F).effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 120, 1), 1.0F).build())));
    public static final RegistryEntry<Item> BEE_SOUP = ITEMS.register("bee_soup", () -> new FoodBowlItem(new Item.Properties().craftRemainder(Items.BOWL).food(BzFoodProperties.builder(12, 1.6F).effect(() -> new MobEffectInstance(BzEffects.BEENERGIZED.get(), 12000, 1), 1.0F).effect(() -> new MobEffectInstance(MobEffects.LEVITATION, 800, 0), 0.2F).effect(() -> new MobEffectInstance(MobEffects.POISON, 800, 0), 0.2F).effect(() -> new MobEffectInstance(MobEffects.SLOW_FALLING, 6000, 0), 0.2F).effect(() -> new MobEffectInstance(MobEffects.LUCK, 18000, 0), 0.2F).effect(() -> new MobEffectInstance(BzEffects.PARALYZED.get(), Math.min(BzGeneralConfigs.paralyzedMaxTickDuration, 200), 0), 0.2F).build())));
    ...
    public static final RegistryEntry<Item> MUSIC_DISC_RIVERS_OF_HONEY_MOSERAO = ITEMS.register("music_disc_rivers_of_honey_moserao", () -> new BzMusicDiscs(4, BzSounds.MUSIC_DISC_RIVERS_OF_HONEY_MOSERAO, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscTimeLengthRiversOfHoney, true));
    ...
    public static final RegistryEntry<Item> MUSIC_DISC_A_LAST_FIRST_LAST = ITEMS.register("music_disc_a_last_first_last", () -> new BzMusicDiscs(7, BzSounds.MUSIC_DISC_A_LAST_FIRST_LAST_MONO, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscTimeAFirstALast, true));
    public static final RegistryEntry<Item> MUSIC_DISC_DROWNING_IN_DESPAIR = ITEMS.register("music_disc_drowning_in_despair", () -> new BzMusicDiscs(6, BzSounds.MUSIC_DISC_DROWNING_IN_DESPAIR_MONO, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscDrowningInDespair, true));
    public static final RegistryEntry<Item> MUSIC_DISC_BEENNA_BOX = ITEMS.register("music_disc_beenna_box", () -> new BzMusicDiscs(5, BzSounds.MUSIC_DISC_BEENNA_BOX_MONO, (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE), () -> BzGeneralConfigs.musicDiscBeennaBox, true));
