...
public class BzEnchantments {
    public static final ResourcefulRegistry<Enchantment> ENCHANTMENTS = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.ENCHANTMENT, Bumblezone.MODID);
