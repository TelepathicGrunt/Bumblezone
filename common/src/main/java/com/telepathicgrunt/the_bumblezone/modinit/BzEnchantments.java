...
public class BzEnchantments {
    ...
    public static final RegistryEntry<DataComponentType<HiveLifelineMarker>> HIVE_LIFELINE_MARKER = ENCHANTMENT_EFFECT_COMPONENT_TYPE.register("hive_lifeline", () -> buildPersistentComponent(HiveLifelineMarker.CODEC));
