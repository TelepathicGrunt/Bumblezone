...
public class BzSurfaceRules {
    ...
    public static final ResourcefulRegistry<Codec<? extends SurfaceRules.RuleSource>> SURFACE_RULES = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.MATERIAL_RULE, Bumblezone.MODID);
