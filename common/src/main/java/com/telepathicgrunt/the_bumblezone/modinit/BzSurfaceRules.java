...
public class BzSurfaceRules {
    ...
    public static final ResourcefulRegistry<Codec<? extends SurfaceRules.RuleSource>> SURFACE_RULES = RegistrationService.INSTANCE.create(BuiltInRegistries.MATERIAL_RULE, Bumblezone.MODID);
