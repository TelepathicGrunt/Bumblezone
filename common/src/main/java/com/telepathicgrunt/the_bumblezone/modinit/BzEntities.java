...
public class BzEntities {
    ...
    public static final RegistryEntry<EntityType<PollenPuffEntity>> POLLEN_PUFF_ENTITY = ENTITIES.register("pollen_puff", () -> PlatformService.INSTANCE.createEntityType(PollenPuffEntity::new, MobCategory.MISC, 0.25F, 0.25F, 0.125f, 4, 3, "pollen_puff"));
    public static final RegistryEntry<EntityType<DirtPelletEntity>> DIRT_PELLET_ENTITY = ENTITIES.register("dirt_pellet", () -> PlatformService.INSTANCE.createEntityType(DirtPelletEntity::new, MobCategory.MISC, 0.5F, 0.5F, 0.15f, 4, 3, "dirt_pellet"));
