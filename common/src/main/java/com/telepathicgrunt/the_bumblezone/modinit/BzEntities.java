...
public class BzEntities {
    ...
    public static final RegistryEntry<EntityType<DirtPelletEntity>> DIRT_PELLET_ENTITY = ENTITIES.register("dirt_pellet", () -> PlatformHooks.createEntityType(DirtPelletEntity::new, MobCategory.MISC, 0.5F, false, 4, 3, "dirt_pellet"));
