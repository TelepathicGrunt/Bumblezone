...
public class BzPOI {
    public static final ResourcefulRegistry<PoiType> POI_TYPES = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.POINT_OF_INTEREST_TYPE, Bumblezone.MODID);
