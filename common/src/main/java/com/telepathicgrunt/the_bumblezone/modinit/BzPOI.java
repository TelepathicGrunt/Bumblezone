...
public class BzPOI {
    public static final ResourcefulRegistry<PoiType> POI_TYPES = RegistrationService.INSTANCE.create(BuiltInRegistries.POINT_OF_INTEREST_TYPE, Bumblezone.MODID);
