...
public class BzStats {
    public static final ResourcefulRegistry<ResourceLocation> CUSTOM_STAT = RegistrationService.INSTANCE.create(BuiltInRegistries.CUSTOM_STAT, Bumblezone.MODID);
