...
public class BzStats {
    public static final ResourcefulRegistry<ResourceLocation> CUSTOM_STAT = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.CUSTOM_STAT, Bumblezone.MODID);
