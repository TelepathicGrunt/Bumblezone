...
public class BzLootConditionTypes {
    ...
    public static final RegistryEntry<LootItemConditionType> DYING_BEE_ENTITY_DROPS = LOOT_ITEM_CONDITION_TYPE.register("dying_bee_entity_drops", () -> new LootItemConditionType(new DyingBeeEntitiesDrops.Serializer()));
    public static final RegistryEntry<LootItemConditionType> BUMBLEZONE_DIMENSION_CHECK = LOOT_ITEM_CONDITION_TYPE.register("bumblezone_dimension_check", () -> new LootItemConditionType(new BumblezoneDimensionCheck.Serializer()));
    public static final RegistryEntry<LootItemConditionType> NON_BUMBLEZONE_DIMENSION_CHECK = LOOT_ITEM_CONDITION_TYPE.register("non_bumblezone_dimension_check", () -> new LootItemConditionType(new NonBumblezoneDimensionCheck.Serializer()));
}
