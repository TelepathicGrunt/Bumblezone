...
public class BzLootConditionTypes {
    ...
    public static final ResourcefulRegistry<LootItemConditionType> LOOT_ITEM_CONDITION_TYPE = RegistrationService.INSTANCE.create(BuiltInRegistries.LOOT_CONDITION_TYPE, Bumblezone.MODID);
