...
public class BzBlocks {
    ...
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE = BLOCKS.register("luminescent_wax_node", () -> new LuminescentWaxNode(MapColor.TERRACOTTA_BROWN, 0));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_RED = BLOCKS.register("luminescent_wax_node_red", () -> new LuminescentWaxNode(MapColor.COLOR_RED, 15));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_PURPLE = BLOCKS.register("luminescent_wax_node_purple", () -> new LuminescentWaxNode(MapColor.COLOR_PURPLE, 15));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_BLUE = BLOCKS.register("luminescent_wax_node_blue", () -> new LuminescentWaxNode(MapColor.COLOR_BLUE, 15));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_GREEN = BLOCKS.register("luminescent_wax_node_green", () -> new LuminescentWaxNode(MapColor.COLOR_GREEN, 15));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_YELLOW = BLOCKS.register("luminescent_wax_node_yellow", () -> new LuminescentWaxNode(MapColor.COLOR_YELLOW, 15));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_WHITE = BLOCKS.register("luminescent_wax_node_white", () -> new LuminescentWaxNode(MapColor.SNOW, 15));
