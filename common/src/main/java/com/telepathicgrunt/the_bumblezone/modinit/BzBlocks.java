...
public class BzBlocks {
    ...
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL = BLOCKS.register("luminescent_wax_channel", () -> new LuminescentWaxChannel(MapColor.TERRACOTTA_BROWN, LuminescentWaxBase.COLOR.NONE));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_RED = BLOCKS.register("luminescent_wax_channel_red", () -> new LuminescentWaxChannel(MapColor.COLOR_RED, LuminescentWaxBase.COLOR.RED));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_PURPLE = BLOCKS.register("luminescent_wax_channel_purple", () -> new LuminescentWaxChannel(MapColor.COLOR_PURPLE, LuminescentWaxBase.COLOR.PURPLE));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_BLUE = BLOCKS.register("luminescent_wax_channel_blue", () -> new LuminescentWaxChannel(MapColor.COLOR_BLUE, LuminescentWaxBase.COLOR.BLUE));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_GREEN = BLOCKS.register("luminescent_wax_channel_green", () -> new LuminescentWaxChannel(MapColor.COLOR_GREEN, LuminescentWaxBase.COLOR.GREEN));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_YELLOW = BLOCKS.register("luminescent_wax_channel_yellow", () -> new LuminescentWaxChannel(MapColor.COLOR_YELLOW, LuminescentWaxBase.COLOR.YELLOW));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_WHITE = BLOCKS.register("luminescent_wax_channel_white", () -> new LuminescentWaxChannel(MapColor.SNOW, LuminescentWaxBase.COLOR.WHITE));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE = BLOCKS.register("luminescent_wax_node", () -> new LuminescentWaxNode(MapColor.TERRACOTTA_BROWN, LuminescentWaxBase.COLOR.NONE));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_RED = BLOCKS.register("luminescent_wax_node_red", () -> new LuminescentWaxNode(MapColor.COLOR_RED, LuminescentWaxBase.COLOR.RED));
