...
public class BzBlocks {
    ...
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL = BLOCKS.register("luminescent_wax_channel", () -> new LuminescentWaxChannel(MapColor.TERRACOTTA_BROWN));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_RED = BLOCKS.register("luminescent_wax_channel_red", () -> new LuminescentWaxChannel(MapColor.COLOR_RED));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_PURPLE = BLOCKS.register("luminescent_wax_channel_purple", () -> new LuminescentWaxChannel(MapColor.COLOR_PURPLE));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_BLUE = BLOCKS.register("luminescent_wax_channel_blue", () -> new LuminescentWaxChannel(MapColor.COLOR_BLUE));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_GREEN = BLOCKS.register("luminescent_wax_channel_green", () -> new LuminescentWaxChannel(MapColor.COLOR_GREEN));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_YELLOW = BLOCKS.register("luminescent_wax_channel_yellow", () -> new LuminescentWaxChannel(MapColor.COLOR_YELLOW));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_CHANNEL_WHITE = BLOCKS.register("luminescent_wax_channel_white", () -> new LuminescentWaxChannel(MapColor.SNOW));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE = BLOCKS.register("luminescent_wax_node", () -> new LuminescentWaxNode(MapColor.TERRACOTTA_BROWN));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_RED = BLOCKS.register("luminescent_wax_node_red", () -> new LuminescentWaxNode(MapColor.COLOR_RED));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_PURPLE = BLOCKS.register("luminescent_wax_node_purple", () -> new LuminescentWaxNode(MapColor.COLOR_PURPLE));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_BLUE = BLOCKS.register("luminescent_wax_node_blue", () -> new LuminescentWaxNode(MapColor.COLOR_BLUE));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_GREEN = BLOCKS.register("luminescent_wax_node_green", () -> new LuminescentWaxNode(MapColor.COLOR_GREEN));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_YELLOW = BLOCKS.register("luminescent_wax_node_yellow", () -> new LuminescentWaxNode(MapColor.COLOR_YELLOW));
    public static final RegistryEntry<Block> LUMINESCENT_WAX_NODE_WHITE = BLOCKS.register("luminescent_wax_node_white", () -> new LuminescentWaxNode(MapColor.SNOW));
    ...
    public static final RegistryEntry<Block> WHITE_ESSENCE_BLOCK = BLOCKS.register("white_essence_block", EssenceBlock::new);
