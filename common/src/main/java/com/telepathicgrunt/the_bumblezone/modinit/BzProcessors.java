...
public class BzProcessors {
    public static final ResourcefulRegistry<StructureProcessorType<?>> STRUCTURE_PROCESSOR = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.STRUCTURE_PROCESSOR, Bumblezone.MODID);
