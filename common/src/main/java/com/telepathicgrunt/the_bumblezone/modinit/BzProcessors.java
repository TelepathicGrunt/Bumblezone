...
public class BzProcessors {
    public static final ResourcefulRegistry<StructureProcessorType<?>> STRUCTURE_PROCESSOR = RegistrationService.INSTANCE.create(BuiltInRegistries.STRUCTURE_PROCESSOR, Bumblezone.MODID);
