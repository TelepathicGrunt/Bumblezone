...
public class BzProcessors {
    ...
    public static final RegistryEntry<StructureProcessorType<ReplaceExistingBlockEntitySafelyProcessor>> REPLACE_EXISTING_BLOCKENTITY_SAFELY_PROCESSOR = STRUCTURE_PROCESSOR.register("replace_existing_blockentity_safely_processor", () -> () -> ReplaceExistingBlockEntitySafelyProcessor.CODEC);
    ...
    public static final RegistryEntry<StructureProcessorType<BlockTickProcessor>> BLOCK_TICK_PROCESSOR = STRUCTURE_PROCESSOR.register("block_tick_processor", () -> () -> BlockTickProcessor.CODEC);
