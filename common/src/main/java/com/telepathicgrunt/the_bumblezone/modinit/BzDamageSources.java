...
public class BzDamageSources {
    ...
    public static final ResourceKey<DamageType> DIRT_PELLET_TYPE = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "dirt_pellet"));
    public static final ResourceKey<DamageType> EVENT_DIRT_PELLET_TYPE = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(Bumblezone.MODID, "event_dirt_pellet"));
}
