...
public class BzDamageSources {
    ...
    public static final ResourceKey<DamageType> BOUNDLESS_CRYSTAL_TYPE = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(Bumblezone.MODID, "boundless_crystal"));
