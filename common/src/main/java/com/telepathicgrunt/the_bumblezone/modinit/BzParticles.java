...
public class BzParticles {
    public static final ResourcefulRegistry<ParticleType<?>> PARTICLE_TYPES = RegistrationService.INSTANCE.create(BuiltInRegistries.PARTICLE_TYPE, Bumblezone.MODID);
