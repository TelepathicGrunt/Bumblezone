...
public class BzParticles {
    public static final ResourcefulRegistry<ParticleType<?>> PARTICLE_TYPES = ResourcefulRegistriesService.INSTANCE.create(BuiltInRegistries.PARTICLE_TYPE, Bumblezone.MODID);
    ...
    public static final RegistryEntry<SimpleParticleType> MOVING_WIND_PARTICLE = PARTICLE_TYPES.register("moving_wind_particle", () -> new SimpleParticleType(false){});
