...
Don't forget to change \<modversion> with the actual latest version of this mod like `4.3.1` for example.
...
&nbsp;&nbsp;&nbsp;&nbsp;modImplementation "com.telepathicgrunt:Bumblezone-Fabric:\<modversion>+1.18.1"
