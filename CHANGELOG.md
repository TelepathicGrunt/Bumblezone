...
##### Mod Compat:
Made Empty Honeycomb Brood Block reviving go to stage 2 brood Block instead of stage 3 if given a baby bee from
...
Resourceful Bees's filled Bee Jar now can be used to revive Empty Honeycomb Brood Blocks by hand or Dispenser.
