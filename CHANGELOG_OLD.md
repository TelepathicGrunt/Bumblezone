...
Put into mostly parity with v6.3.9 Fabric Bumblezone which also includes Continuity compat


### **(V.6.3.0) (1.19.2 Minecraft)**

##### Major:
Ported all Fabric Bumblezone stuff to Fabric version to make Fabric version be in parity.
